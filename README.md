...
This is `terraform-aws-firewall-manager` project provides all the scaffolding for a typical well-built Cloud Posse module. It's a template repository you can
...
```hcl
module "example" {
  source = "https://github.com/cloudposse/terraform-aws-firewall-manager.git?ref=master"
  example = "Hello world!"
}
```
