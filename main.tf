locals {
  ...
  logging_configuration           = local.enabled && var.firehose_enabled ? local.logging_config_firehose_enabled : local.enabled && var.firehose_arn != null ? tomap(local.logging_config_firehose_arn) : {}
